---
title: "GBRCD Example R Code for CSV version"
...
## R Markdown document with example code for handling GBRCD
...
# Add columns to convert decimal dates to dates, month and year
  # Note: lubridate date_decimal function assumes astronomical numbering so conversion 
...
```{r gbrcd nominal resolution area stacks plot}
...
```{r gbrcd record coverage area stacks plot}
