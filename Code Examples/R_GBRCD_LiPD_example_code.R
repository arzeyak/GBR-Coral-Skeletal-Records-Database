...
# Example of loading GBRCD data from lipdverse (v1_0_0 is the current version as of February 2024). Check https://lipdverse.org/GBRCD/current_version/ for updates.

# Alternatively, data can be loaded from a local copy of the GBRCD.


# Load data from lipdverse
gbrcd_lipd <- readLipd('https://lipdverse.org/GBRCD/current_version/GBRCD1_0_0.zip')

# Alternatively load the GBRCD from a local copy of the data.
# Unzip the GBRCD zip file (i.e. GBRCD1_0_0.zip) before running the code.
...
# Prepare and plot LiPD data time series stack of 'modern' Ba/Ca data in the GBR south of 22.5 S (< -22.5)
...
# Prepare and plot LiPD data for 'modern' (post 1700 CE) Ba/Ca data (entire GBR, southern GBR (i.e. south of 20 S) and southern GBR south of -22.5 since 1950) 


# Create tidy TS object and filter for data from 1500s-present
